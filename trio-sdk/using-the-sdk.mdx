...
* Read the API Reference on how to create a [Checkout Session](#/reference/banking-api/checkout).
...
* [Pay-in](#/guides/sdk/flows/pay-in)
* [Payout](#/guides/sdk/flows/payout)
...
* [Pay-in webhook (collecting document)](#/developers/webooks/events/collecting-document)
* [Payout webhook (payment document)](#/developers/webooks/events/payment-document)
