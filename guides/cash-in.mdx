...
[https://docs.trio.com.br(trocar após publicação da doc)/api\_reference/banking-api/collecting/dynamic-qr-codes#post-banking-cashin-pix-qrcodes](https://docs.trio.com.br(trocar após publicação da doc)/api_reference/banking-api/collecting/dynamic-qr-codes#post-banking-cashin-pix-qrcodes)
