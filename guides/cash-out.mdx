...
[https://docs.trio.com.br(trocar após publicação da doc)/api\_reference/banking-api/payment/pix-key](https://docs.trio.com.br(trocar após publicação da doc)/api_reference/banking-api/payment/pix-key)
